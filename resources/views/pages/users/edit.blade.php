    ...
    <div class="custom_form max-w-2xl mx-auto py-4">
        ...
        <form action="{{ route('users.update', $user->uuid) }}" method="post">
            ...
            <div class="inputs">
                ...
                <input type="text" name="first_name" id="first_name" autocomplete="given-name" value="{{ old('first_name', $user->first_name) }}" autofocus>
                <x-form-input-error field="first_name" />
            </div>

            <div class="inputs">
                <label for="last_name" class="required">Last Name</label>
                <input type="text" name="last_name" id="last_name" autocomplete="family-name" value="{{ old('last_name', $user->last_name) }}">
            ...
            <div class="inputs">
                ...
                <input type="text" name="phone_number" id="phone_number" placeholder="2547xxxxxxxx or 2541xxxxxxxx" autocomplete="phone-number" value="{{ old('phone_number', $user->phone_number) }}">
